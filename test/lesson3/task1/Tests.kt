...
class Tests {
    ...
    fun lcm() {
        ...
        assertEquals(10000, lcm(10000, 10000))//дополнительный тест
        assertEquals(200000, lcm(200000, 100000))//дополнительный тест
        assertEquals(200000, lcm(100000, 200000))//дополнительный тест
    }
